...
\title[Seminar Topic]%
      {Seminar Topic about Computer Graphics in Movies}

% for anonymous conference submission please enter your SUBMISSION ID
% instead of the author's name (and leave the affiliation blank) !!
\author[M.Kern \& M.Kern]
{\parbox{\textwidth}{\centering Michael Kern$^1$% 
...
\teaser{
 \includegraphics[width=\linewidth]{img/smoke-teaser.jpg}
 \centering
